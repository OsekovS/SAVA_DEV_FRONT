...
const ListElem = (props) => {
    ...
    if(props.filter){
        ...
        Elements.push(<td className="icon comment"  data-title="фильтр" >
    ...
    if(props.change)
        Elements.push(<td className="icon comment"  data-title="редактирование" >
        <img onClick={props.onChangeClick.bind(this,props.id)} width={15} height={15} src={require('./notification.svg')}/>
    </td>)
    if(props.delete)
        Elements.push(<td className="icon comment"  data-title="удаление" >
